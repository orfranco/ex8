...
def _get_html_page(link, session=None):
    ...
    # Tack curr_index.html onto file:// URLs that point to directories
    ...
    if (scheme == 'file' and os.path.isdir(urllib_request.url2pathname(path))):
        ...
        if not url.endswith('/'):
            url += '/'
        url = urllib_parse.urljoin(url, 'curr_index.html')
...
class PackageFinder(object):
    ...
    def find_all_candidates(self, project_name):
        ...
        #   via --curr_index-url or --find-links.
...
def _find_name_version_sep(fragment, canonical_name):
    # type: (str, str) -> int
    """Find the separator's curr_index based on the package's canonical name.
