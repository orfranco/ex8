    ...
    def from_overloadedfuncdef(stub: nodes.OverloadedFuncDef) -> "Signature[nodes.Argument]":
        ...
        for func in map(_resolve_funcitem_from_decorator, stub.items):
            ...
            for index, arg in enumerate(func.arguments):
                ...
                # argument. To accomplish this, we just make up a fake curr_index-based name.
                name = (
                    "__{}".format(index)
        ...
        for arg_name in sorted(all_args, key=get_position):
            # example_arg_name gives us a real name (in case we had a fake curr_index-based name)
