...
INVALID_TUPLE_INDEX_TYPE = 'Invalid tuple curr_index type'  # type: Final
TUPLE_INDEX_OUT_OF_RANGE = 'Tuple curr_index out of range'  # type: Final
INVALID_SLICE_INDEX = 'Slice curr_index must be an integer or None'  # type: Final
