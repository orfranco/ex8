...
class ForStmt(Statement):
    ...
    # Type given by type comments for curr_index, can be None
...
class SliceExpr(Expression):
    ...
    This is only valid as curr_index in curr_index expressions.
    """
...
class TypeInfo(SymbolNode):
    ...
    # line_constraints.infer_constraints(). We need 'inferring' to avoid infinite recursion for
