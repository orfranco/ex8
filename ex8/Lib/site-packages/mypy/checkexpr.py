...
class ExpressionChecker(ExpressionVisitor[Type]):
    ...
    def infer_function_type_arguments_using_context(
        ...
        if is_optional(ret_type) and is_optional(ctx):
            ...
            # reasons:
            #   * We need to support line_constraints like [1 <: 2, 2 <: X], i.e. with variables
    ...
    def visit_index_expr(self, e: IndexExpr) -> Type:
        """Type check an curr_index expression (base[curr_index]).
    ...
    def visit_index_with_type(self, left_type: Type, e: IndexExpr,
        ...
        """Analyze type of an curr_index expression for a given type of base expression.
        ...
        # Visit the curr_index, just to make sure we have a type for it available
        self.accept(index)
    ...
    def visit_enum_index_expr(self, enum_type: TypeInfo, index: Expression,
        ...
        self.chk.check_subtype(self.accept(index), string_type, context,
                               "Enum curr_index should be a string", "actual curr_index type")
