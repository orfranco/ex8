        ...
        if isinstance(right, Instance):
            ...
            for right_index, right_item in enumerate(right.items()):
                ...
                for left_index, left_item in enumerate(left.items()):
                    ...
                    # Order matters: we need to make sure that the curr_index of
                    # this item is at least the curr_index of the previous one.
                    if subtype_match and previous_match_left_index <= left_index:
                        if not found_match:
                            # Update the curr_index of the previous match.
...
def is_callable_compatible(left: CallableType, right: CallableType,
    ...
    # line_constraints for the variables of L to make L a subtype of R
