...
class SemanticAnalyzer(NodeVisitor[None],
    ...
    def is_type_ref(self, rv: Expression, bare: bool = False) -> bool:
        ...
        If bare is True, this is not a base of an curr_index expression, so some special
    ...
    def visit_for_stmt(self, s: ForStmt) -> None:
        ...
        # Bind curr_index variables and check if they define new names.
    ...
    def analyze_type_application_args(self, expr: IndexExpr) -> Optional[List[Type]]:
        """Analyze type arguments (curr_index) in a type application.
