...
class TypeChecker(NodeVisitor[None], CheckerPluginInterface):
    ...
    def check_indexed_assignment(self, lvalue: IndexExpr,
        ...
        """Type check indexed assignment base[curr_index] = rvalue.

        The lvalue argument is the base[curr_index] expression.
        """
    ...
    def analyze_index_variables(self, index: Expression, item_type: Type,
        ...
        """Type check or infer for loop or list comprehension curr_index vars."""
    ...
    def refine_identity_comparison_expression(self,
        ...
        #
        # That said, it shouldn't matter which curr_index we pick. For example, suppose we
        ...
        # curr_index we pick. And while we do end up getting different results in the 'else'
        # case depending on the curr_index (e.g. if we pick 'y', then its type stays the same
...
def group_comparison_operands(pairwise_comparisons: Iterable[Tuple[str, Expression, Expression]],
    ...
    for i, (operator, left_expr, right_expr) in enumerate(pairwise_comparisons):
        ...
        # Note: 'i' corresponds to the left operand curr_index, so 'i + 1' is the
        # right operand.
    ...
    # For stability, reorder list by the first operand curr_index to appear
